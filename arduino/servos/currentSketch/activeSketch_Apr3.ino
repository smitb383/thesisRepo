...
int midPts[numMidPts] ={0,0, halfRail, halfRail, halfRail};
//int midPts[numMidPts] ={1900, 400, 100, 2400, 2600};
int midPtsCnt = 0; 
...
//          Serial.println(newCenter); 
           Serial.println("NEW CENTER VALUE " + String(newCenter)); 
            ...
            for(int i = 0; i<numMidPts-1; i++){
              midPts[i] = midPts[i+1]; 
              Serial.println("midpt number " + String(i) + " = " + String(midPts[i])); 
            }
            midPts[4] = newCenter; 
             Serial.println("midpt number 4 = " + String(midPts[4])); 
...
//        delay(1);
    ...
    Serial.println("GOING TO NEW MIDDLE @: " + String(middlePt)); 
